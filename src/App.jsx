...
// Tom's Intelligence Logo (white version)
const TOMS_LOGO = "https://i.imgur.com/placeholder.png"; // We'll use inline SVG instead
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
          <div className="bg-slate-800/90 backdrop-blur-xl rounded-2xl p-8 border border-slate-700 w-full max-w-md shadow-2xl">
            <div className="text-center mb-6">
              {/* Tom's Intelligence Logo */}
              <div className="flex justify-center mb-4">
                <img src="/logo.png" alt="Tom's Intelligence" className="h-32 w-auto" />
              </div>
